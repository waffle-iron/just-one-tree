...
function justonetree_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'justonetree_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'justonetree_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'justonetree_custom_header_setup' );

if ( ! function_exists( 'justonetree_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see justonetree_custom_header_setup().
 */
function justonetree_header_style() {
...
endif; // justonetree_header_style